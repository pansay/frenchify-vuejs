...
var _rules = _interopRequireDefault(require("./rules/rules.json"));

var _rulesFr = _interopRequireDefault(require("./rules/rules-fr.json"));

var _rulesEs = _interopRequireDefault(require("./rules/rules-es.json"));

var _rulesEn = _interopRequireDefault(require("./rules/rules-en.json"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var languageRules = [{
  id: 'fr',
  rules: _rulesFr.default
}, {
  id: 'en',
  rules: _rulesEn.default
}, {
  id: 'es',
...
module.exports=[
    ...
    {
        "from": "(?!^)\\((\\d*?-?\\d*)\\)",
        "to": "<sup><a href=\"#footnote-$1\" id=\"fn-ref-$1\">$1</a></sup>"
    },
    {
        "from": "^\\((\\d*?-?\\d*)\\)",
        "to": "<sup><a href=\"#fn-ref-$1\" id=\"footnote-$1\">$1</a></sup>"
    }
]
...
/*#__PURE__*/
function () {
  function Frenchify(rulesArray) {
    _classCallCheck(this, Frenchify);

    _defineProperty(this, "rulesArray", []);
  ...
  _createClass(Frenchify, [{
    key: "applyRules",
    value: function applyRules(content) {
      var _this = this;

      this.rulesArray.forEach(function (rules) {
        content = _this.replace(content, rules);
      });
      return content;
    }
  }, {
    key: "replace",
    value: function replace(content, rules) {
...
},{"timers":10}],12:[function(require,module,exports){
"use strict";
...
},{"../i18n/en.json":1,"../node_modules/vue/dist/vue":11,"frenchify-rules":2,"showdown":9}]},{},[12]);
